...
Free, community-maintained DNS blocklists against ads, trackers, malware, phishing, and other junk — for Pi-hole, AdGuard, DNS servers, and most ad/content blockers.

⭐ If this project has helped you, drop a star (top right) — it genuinely helps.
...
| I want to... | Go to |
|:---|:---|
| A recommendation for my setup | [Which list should I use?](FAQ.md#whatshouldiuse) |
| Every list at a glance | [Cheat Sheet](CHEATSHEET.md) |
| Just something solid, no research | **[Multi Pro](#pro)** — balanced ad/tracker/threat blocking, works for most people |
| To set it up | [Quick setup guide](FAQ.md#quicksetup) |

---

### 📖 Format Guide

Every list ships in several formats — pick the one your tool needs. This applies throughout the whole document, so individual sections below only link the files, not the app list.

| Format | Works with |
|:---|:---|
| **Adblock** | Pi-hole, AdGuard, AdGuard Home, eBlocker, uBlock Origin, Brave (aggressive mode), AdBlock-Fast, AdNauseam, Little Snitch Mini |
| **DNSMasq** | DNSMasq (v2.86+), Diversion (v5+) |
| **Wildcard (Asterisk)** | Blocky (v0.23+), Nebulo, NetDuma, OPNsense, YogaDNS |
| **Wildcard (Domains)** | DNSCloak, DNSCrypt, FRITZ!Box (≥ v8.40), TechnitiumDNS, adblock-lean, PersonalDNSfilter, InviZible Pro |
| **RPZ** | Response Policy Zone: Bind, Knot, PowerDNS, Unbound |
| **ControlD** | Import as a ControlD folder |

> [!TIP]
> Very large lists (Pro++/Ultimate/TIF) don't fit size-constrained tools like Little Snitch Mini or the iOS AdGuard app — grab a `mini`/`medium` variant instead where offered.

Each list section below has a collapsed **📎 Show download links & formats** box — click to expand it and grab the file you need.
...
**Protection levels**
- [Overview](#overview)
- [Light](#light) · [Normal](#normal) · [Pro](#pro) ([mini](#promini)) · [Pro++](#proplus) ([mini](#proplusmini)) · [Ultimate](#ultimate) ([mini](#ultimatemini))

**Specialized security lists**
- [Fake / Scam Sites](#fake)
- [Pop-Up Ads](#popupads)
- [Threat Intelligence Feeds](#tif) ([medium](#tifmedium) · [mini](#tifmini) · [IPs](#tifips))
- [Newly Registered Domains — NRD/DGA](#nrd)

**Access & bypass control**
- [DoH/VPN/TOR/Proxy Bypass](#bypass) ([full](#bypass_all) · [DoH only](#bypass_dns) · [DoH IPs](#bypass_ips))
- [Safesearch Enforcement](#safesearch)
- [Dynamic DNS](#dyndns)
- [Badware Hoster](#hoster)
- [URL Shortener](#urlshortener)
- [Most Abused TLDs](#tlds)
- [DNS Rebind Protection](#dnsrebind)

**Content filters**
- [Anti Piracy](#piracy)
- [Gambling](#gambling) ([medium](#gamblingmedium) · [mini](#gamblingmini))
- [Social Networks](#social)
- [NSFW](#nsfw)
- [Native Tracker](#native)

**Reference**
- [Blocklists Cheat Sheet](CHEATSHEET.md)
- [Recommendation — which list should I use?](FAQ.md#whatshouldiuse)
- [Online DNS Services](#dnsservices) ([HaGeZi DNS](#hagezidns) · [DNSBunker](#dnsbunker))
- [FAQ](FAQ.md)
- [Sources](sources.md)
- [About](#about) ([Repository](#repository) · [Referral Domains](#referral) · [Support](#support))
- [Update Interval / Mirrors](#mirrors)
- [Disclaimer](#disclaimer)
- [Contact](#contact)
- [Discussions](https://github.com/hagezi/dns-blocklists/discussions)

### 📚 **Multi, cleans up the internet and protects your privacy!** <a name="overview"></a>
...
|:--------|---:|:------:|:-----:|:----:|:----:|:---:|:------:|:----------:|:----:|:----:|
| 📗[Light](#light)             | 42089     |  |   |   | 🟢  |  | |  🟡 | 🟡 | |
| 📘[Normal](#normal)       | 188380     |  |   | 🟢 | 🟢 | 🟢 | 🟡 | 🟡 | 🟡 | |
| 📒[Pro](#pro)              | 224127         |  | 🟢 | 🟢 | 🟢 | 🟢 | 🟡 | 🟡 | 🟢 | 🟢 |
| 📙[Pro++](#proplus)    | 248112 | 🟢 | 🟢 | 🟢 | 🟢 | 🟢 |🟡 | 🟡 | 🟢 | 🟢 |
| 📕[Ultimate](#ultimate)    | 266820 | 🟢 | 🟢 | 🟢 | 🟢 | 🟢  | 🟡 | 🟢 | 🟢 | 🟢 |
...
|:--------|:---------------|:--------------|
| 📗[Light](#light)        | 📗 📗                                                                    | Relaxed             |
| 📘[Normal](#normal)       | 📘 📘 📘                                                           | Relaxed/Balanced    |
| 📒[Pro](#pro)                | 📒 📒 📒 📒                                                            | Balanced            |
| 📙[Pro++](#proplus)     | 📙 📙 📙 📙 📙 📙              | Balanced/Aggressive |
| 📕[Ultimate](#ultimate) | 📕 📕 📕 📕 📕 📕 📕 | Aggressive |

> [!TIP]
> 💁 [Not sure which version fits you? Check this out.](FAQ.md#whatshouldiuse)
...
<details>
<summary>📎 Show download links &amp; formats</summary>

| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/light.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/light.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/light.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/light-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/light.txt) |
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/multi.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/multi.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/multi.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/multi-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/multi.txt) |
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/pro.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/pro.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/pro.txt) |

</details>

#### 📒 **Multi PRO mini (best for browser/mobile ad blockers)** <a name="promini"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/pro.mini.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/pro.mini.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro.mini.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro.mini-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/pro.mini.txt) |
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/pro.plus.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/pro.plus.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro.plus.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro.plus-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/pro.plus.txt) |

</details>

#### 📙 **Multi PRO++ mini** <a name="proplusmini"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/pro.plus.mini.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/pro.plus.mini.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro.plus.mini.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/pro.plus.mini-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/pro.plus.mini.txt) |
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/ultimate.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/ultimate.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/ultimate.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/ultimate-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/ultimate.txt) |

</details>

#### 📕 **Multi ULTIMATE mini** <a name="ultimatemini"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/ultimate.mini.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/ultimate.mini.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/ultimate.mini.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/ultimate.mini-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/ultimate.mini.txt) |

</details>

---

### 🧌 **Fake, blocks scams, traps, and fake sites!** <a name="fake"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/fake.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/fake.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/fake.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/fake-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/fake.txt) |

</details>

---

### 🎉 **Pop-Up Ads, stops annoying and malicious pop-ups!** <a name="popupads"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/popupads.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/popupads.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/popupads.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/popupads-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/popupads.txt) |

</details>

---

### 🔐 **Threat Intelligence Feeds, a serious security boost (recommended)** <a name="tif"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/tif.txt)<br><sub>ℹ️ too big for iOS AdGuard mobile app · needs >= 2GB RAM!</sub> |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/tif.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/tif.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/tif-onlydomains.txt) |
| RPZ<br>(split) | 1️⃣ [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/tif-1.txt)<br>2️⃣ [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/tif-2.txt)<br><sub>ℹ️ **Note:** this list had to be split into two parts because of its size. You need both.</sub> |

</details>

#### 🔐 **Threat Intelligence Feeds, medium version (best for browser/mobile ad blockers)** <a name="tifmedium"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/tif.medium.txt)<br><sub>ℹ️ too big for iOS AdGuard mobile app · needs >= 1GB RAM!</sub> |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/tif.medium.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/tif.medium.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/tif.medium-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/tif.medium.txt) |

</details>

#### 🔐 **Threat Intelligence Feeds, mini version** <a name="tifmini"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/tif.mini.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/tif.mini.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/tif.mini.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/tif.mini-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/tif.mini.txt) |

</details>

#### 🔐 **Threat Intelligence Feeds, IPs** <a name="tifips"></a>
...
### 🆕 **Newly Registered Domains (NRD/DGA)** <a name="nrd"></a>
...
> - Stamus Labs: 🟢 - Sun, 23 Aug 2026 04:23:33 UTC / 10887301 domains
...
### 📤 **DoH/VPN/TOR/Proxy Bypass, stop people from sneaking around your DNS!** <a name="bypass"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/doh-vpn-proxy-bypass.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/doh-vpn-proxy-bypass.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/doh-vpn-proxy-bypass.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/doh-vpn-proxy-bypass-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/doh-vpn-proxy-bypass.txt) |
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/doh.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/doh.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/doh.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/doh-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/doh.txt) |

</details>

#### 📤 **Encrypted DNS server IPs** <a name="bypass_ips"></a>
...
### 🔍 **Safesearch not supported, blocks search engines that skip Safesearch!** <a name="safesearch"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/nosafesearch.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/nosafesearch.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/nosafesearch.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/nosafesearch-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/nosafesearch.txt) |

</details>

---

### 🔏 **Dynamic DNS blocking, guards against dynamic DNS abuse!** <a name="dyndns"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/dyndns.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/dyndns.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/dyndns.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/dyndns-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/dyndns.txt) |

</details>

---

### 💻 **Badware Hoster blocking, guards against malicious hosting services!** <a name="hoster"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/hoster.txt) |
...
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/hoster-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/hoster.txt) |
| ControlD | [Link](https://github.com/hagezi/dns-blocklists/blob/main/controld/badware-hoster-folder.json) |

</details>

---

### 📲 **URL Shortener, blocks link shorteners!** <a name="urlshortener"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/urlshortener.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/urlshortener.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/urlshortener.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/urlshortener-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/urlshortener.txt) |

</details>

---

### 🔮 **Most Abused TLDs, blocks known shady top-level domains! (recommended)** <a name="tlds"></a>
...
| Format | Link |
|:-------|:-----|
| AdGuard | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/spam-tlds.txt) |
| uBlock Origin | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/spam-tlds-ublock.txt) |
| AdBlock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/spam-tlds-adblock.txt)<br><sub>ℹ️ Pi-hole, TechnitiumDNS<br>Only includes spam TLDs with no exclusions.</sub> |
| AdBlock<br>(Aggressive)<br><br>Allowlist<br><br> | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/spam-tlds-adblock-aggressive.txt)<br><br>[Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/spam-tlds-adblock-allow.txt)<br><sub>ℹ️ Pi-hole, TechnitiumDNS</sub> |
| Wildcard<br>Domains<br><br>Allowlist<br><br> | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/spam-tlds-onlydomains.txt)<br><br>[Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/spam-tlds-allow-onlydomains.txt)<br><sub>ℹ️ DNSCrypt</sub> |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/spam-tlds-rpz.txt)<br><sub>ℹ️ Response Policy Zone, Bind, Knot, PowerDNS, Unbound<br>Only includes spam TLDs with no exclusions.</sub> |
| RPZ<br>(Aggressive) | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/spam-tlds-rpz-aggressive.txt)<br><sub>ℹ️ Response Policy Zone, Bind, Knot, PowerDNS, Unbound<br>Includes all spam TLDs, matching the AdGuard/uBlock Origin version without exclusions.</sub> |
| ControlD | [Link](https://github.com/hagezi/dns-blocklists/blob/main/controld/spam-tlds-combined-folder.json) |

</details>

---

### 🛡️ **DNS Rebind Protection, stops attackers from pointing domains at your local network!** <a name="dnsrebind"></a>
...
### 💀 **Anti Piracy, blocks piracy sites!** <a name="piracy"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/anti.piracy.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/anti.piracy.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/anti.piracy.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/anti.piracy-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/anti.piracy.txt) |

</details>

---

### 🎰 **Gambling, blocks gambling content!** <a name="gambling"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/gambling.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/gambling.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/gambling.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/gambling-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/gambling.txt) |

</details>

#### 🎰 **Gambling, medium version** <a name="gamblingmedium"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/gambling.medium.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/gambling.medium.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/gambling.medium.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/gambling.medium-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/gambling.medium.txt) |

</details>

#### 🎰 **Gambling, mini version** <a name="gamblingmini"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/gambling.mini.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/gambling.mini.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/gambling.mini.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/gambling.mini-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/gambling.mini.txt) |

</details>

---

### 💬 **Social Networks, blocks access to social networks!** <a name="social"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/social.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/social.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/social.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/social-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/social.txt) |

</details>

---

### 🔞 **NSFW, blocks adult content!** <a name="nsfw"></a>
...
| Format | Link |
|:-------|:-----|
| Adblock | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/adblock/nsfw.txt) |
| DNSMasq | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/dnsmasq/nsfw.txt) |
| Wildcard<br>Asterisk | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/nsfw.txt) |
| Wildcard<br>Domains | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/nsfw-onlydomains.txt) |
| RPZ | [Link](https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/rpz/nsfw.txt) |

</details>

---

### 📲 **Native Tracker, built-in trackers from devices, apps, and OSes** <a name="native"></a>
...
> [!TIP]
> 💁 [Still not sure which version to pick?](FAQ.md#whatshouldiuse)
...
🟡 Included as part of ControlD's native category lists.
📓 Available as a [ControlD folder](https://github.com/hagezi/dns-blocklists/tree/main/controld).

#### 🏬 **DNSBUNKER.org (EU: Germany, balanced blocking), free** <a name="dnsbunker"></a>
...
#### 🏬 **HaGeZi DNS (EU: Germany/Finland, balanced blocking), free** <a name="hagezidns"></a>

HaGeZi DNS runs free, non-commercial public resolvers for Europe, mixing privacy and security with minimal restrictions using the Multi Pro and Threat Intelligence Feed lists. More details in the [project repository](https://github.com/hagezi/dns-servers).

<details>
<summary>📎 Show endpoints (ads+trackers+threats, and threats-only)</summary>
...
#### 🏬 **AdGuardDNS, limited free / unlimited trial / paid** <a name="adguarddns"></a>
...
<details>
<summary>📎 Show free-tier endpoints, paid guide &amp; automation</summary>
...
**Paid:** Check out Yokoffing's [ControlD Config Guide](https://github.com/yokoffing/Control-D-Config) for good [ControlD](https://controld.com) settings.
...
#### 🏬 **Public RDNS (EU: Finland, family-safe, aggressive blocking), free** <a name="publicrdns"></a>

[Public RDNS](https://public-rdns.com/) is a free, no-log recursive resolver for families that uses HaGeZi lists to aggressively block ads, trackers, malware, NSFW content, piracy, gambling, and other unwanted domains. More info on the [project page](https://public-rdns.com).

#### 🏬 **RobinGroppe.de (EU: Germany, threat blocking), free** <a name="robingroppe"></a>
...
[OpenBLD.net](https://openbld.net/docs/get-started/third-party-filters/hagezi/) combines the Pro list with the TIF blocklist: `https://ric.openbld.net/dns-query/hagezi`
...
Built with 💓 for a safer, cleaner internet.

Every list gets tested against 10,000 websites from the Cisco Umbrella Top 1 million list. I check whether pages load properly, content displays correctly, navigation works, images load, videos play, and so on. So no, these aren't just random lists stitched together from other sources — curious how they're built? Check out: [Which sources are used and how are the lists compiled?](FAQ.md#sources)

<details>
<summary>📎 Show blocking-rate test results (vs. 10,000 whotracks.me pages)</summary>

Tested against the 10,000 [whotracks.me](https://whotracks.me/websites.html) pages, all opened and fully loaded in batch via Edge with privacy features turned off, and cookies accepted.
...
### 💾 Update Interval/Official Mirrors <a name="mirrors"></a>
...
Free, "as is," no warranty, use at your own risk — the usual open-source terms, published under GPL-3.0. Full legal text:

<details>
<summary>📎 Show full disclaimer</summary>
